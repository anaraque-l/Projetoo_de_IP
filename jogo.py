...
IMAGENS = {
    'ladrao': pygame.transform.scale(pygame.image.load('ladrao.webp'), (TAMANHO_CELULA, TAMANHO_CELULA)),
    'policia': pygame.transform.scale(pygame.image.load('policia.webp'), (TAMANHO_CELULA, TAMANHO_CELULA)),
    'acelera_policia': pygame.transform.scale(pygame.image.load('acelera_policia.webp'), (TAMANHO_CELULA, TAMANHO_CELULA)),
    'desacelera_policia': pygame.transform.scale(pygame.image.load('desacelera_policia.webp'), (TAMANHO_CELULA, TAMANHO_CELULA)),
    'acelera_ladrao': pygame.transform.scale(pygame.image.load('acelera_ladrao.webp'), (TAMANHO_CELULA, TAMANHO_CELULA)),
    'arma': pygame.transform.scale(pygame.image.load('arma.webp'), (TAMANHO_CELULA, TAMANHO_CELULA)),
}
